...
9. 如果你需要图片支持，请给我反馈，告诉我需要什么图片。。目前我在F:\AppSimV2\android_template\android_template\app\src\main\assets文件夹下放了avatar和cover两个文件夹，分别是用户或歌手头像和歌曲专辑封面的图片，你可以使用里面的图片。
...
## 可参考的截图
UIReference/MeTab.jpg

UIReference/SearchTab.jpg

UIReference/YourLibraryTab.jpg

UIReference/PremiumTab.jpg


## 你当前的任务
2. 根据参考的截图，帮我完成四个主页面的开发